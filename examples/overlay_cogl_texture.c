          ...
          gpointer       data)
{
  ...
  CoglTexture *cogl_texture = (CoglTexture*) data;
  openvr_overlay_upload_cogl (overlay, cogl_texture);
}
...
CoglTexture*
create_cogl_texture_from_pixbuf (GdkPixbuf *pixbuf)
{
  CoglError *error = NULL;
...
test_cat_overlay ()
{
  ...
  CoglTexture* cogl_tex =
    create_cogl_texture_from_pixbuf (pixbuf);
  ...
  g_signal_connect (overlay, "show", (GCallback) _show_cb, cogl_tex);
